...
router.patch('/usersProducts/updateProduct/:productId', productCtrl.updateProduct);
router.delete('/usersProducts/deleteProduct/:productId', productCtrl.deleteProduct);
